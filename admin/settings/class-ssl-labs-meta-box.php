...
class SSL_Labs_Meta_Box {
	...
	public function __construct( $plugin_name ) {
		...
		$this->options_tabs = SSL_Labs_Settings_Definition::get_tabs();
	}
	...
	public function add_meta_boxes() {
		...
		foreach ( $this->options_tabs as $tab_id => $tab_name ) {
			...
			add_meta_box(
					...
					'ssl_quality_checker_settings_' . $tab_id, // Screen to which to add the meta box
					'normal'							// Context
					);
